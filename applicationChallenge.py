...
# Prepend this string to ‘@trackview.io’ and send your CV to the address (e.g., 1_2_3_4@trackview.io).
# ---------------
...
# Prepend this string to ‘@trackview.io’

resultArray = []
for x in range(7, 1001, 7):
    if x%5 and not x%13:
        resultArray.append(str(x))
email = "_".join(resultArray) + "@trackview.io"
print(email)